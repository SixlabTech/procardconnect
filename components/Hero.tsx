  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      <div className=" flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        <Image src={discount} alt="discount" className="w-[32px] h-[32px]" />
        <p className={`${styles.paragraph} ml-2`}>
          <span className="text-white">10%</span> de réduction{" "}
          <span className="text-white">sur votre</span> achat
      
        </p>
      </div>
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 font-poppins font-semibold ss:text-[70px] text-[50px] text-white ss:leading-[100px] leading-[75px]">
        Démarquez-vous avec nos <br className="sm:block hidden" />{" "}
      ...
      <span className="text-gradient">de Visite NFC</span>{" "}
      </h1>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
      Grâce à nos cartes de visite NFC, vous pouvez désormais partager instantanément vos coordonnées, vos réseaux sociaux et bien plus encore, simplement en effleurant votre carte avec un smartphone.
      </p>
    </div>
    <div className={`${styles.flexCenter} flex-1 flex md:my-0 my-10 relative`}>
      <Image
