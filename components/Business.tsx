...
const Business: React.FC = () => (
  <section id="features" className={`${layout.section}`}>
    <div className={layout.sectionInfo}>
      <h2 className={styles.heading2}>
        Boostez vos échanges, <br className="sm:block hidden" />
        avec nos cartes de visite NFC.
      </h2>
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
        Simplifiez vos interactions professionnelles grâce à nos cartes de visite NFC. 
        Partagez instantanément vos coordonnées avec un simple scan, sans avoir à imprimer des cartes en papier. 
        Une solution moderne, écologique et efficace.
      </p>
      <Button styles="mt-10" />
    </div>
    <div className={`${layout.sectionImg} flex-col`}>
